        ...
        Container(
          ...
          child: Column(
            ...
            children: [
              ...
              buildRow(AppIcons.city, "سعر الوحدة", "760.000.000 ر.س"),
              buildRow(AppIcons.unitStatus, "الضريية العقارية", "38.000.000 ر.س"),
              buildRow(AppIcons.laddar, "السعي", "00.00 ر.س"),
              buildRow(AppIcons.bedroom, "غرف النوم", "4+خادمة"),
              buildRow(AppIcons.bathroom, "ضريبة السعي", "760.000.000 ر.س"),
              buildRow(AppIcons.square, "مساحة", "800sqFt."),
              buildRow(AppIcons.date, "المبلغ الاجمالي", "798.000.000 ر.س"),
            ],
          ),
        ),
        const BlueDivider(),
